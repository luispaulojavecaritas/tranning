...
public class TipoEstatusBean {
	...
	private List<TipoEstatus> lista = new ArrayList<>();
	private List<TipoEstatus> listafiltro;
	private TipoEstatus entidad = new TipoEstatus();
	private TipoEstatus entidadseleccionada = new TipoEstatus();

	private String filtro;

	@EJB
	private TipoEstatusService servicio = new TipoEstatusServiceImpl();

	public TipoEstatusBean() {
	...
	public List<TipoEstatus> getLista() {
		return lista;
	}

	public void setLista(List<TipoEstatus> lista) {
		this.lista = lista;
	}

	public List<TipoEstatus> getListafiltro() {
		return listafiltro;
	}

	public void setListafiltro(List<TipoEstatus> listafiltro) {
		this.listafiltro = listafiltro;
	}

	public TipoEstatus getEntidad() {
		return entidad;
	}

	public void setEntidad(TipoEstatus entidad) {
		this.entidad = entidad;
	}

	public TipoEstatus getEntidadseleccionada() {
		return entidadseleccionada;
	}

	public void setEntidadseleccionada(TipoEstatus entidadseleccionada) {
		this.entidadseleccionada = entidadseleccionada;
	}

	public void setServicio(TipoEstatusService servicio) {
	...
	public void onRowSelect(SelectEvent event) {
		if (entidadseleccionada == null) {
			entidad = new TipoEstatus();
			entidadseleccionada = new TipoEstatus();
			FacesContext.getCurrentInstance().addMessage(null,
