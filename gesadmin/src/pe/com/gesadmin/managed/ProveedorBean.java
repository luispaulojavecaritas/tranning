...
public class ProveedorBean {
	...
	public String guardar() {
		...
		if (proveedor.getTelefonoCelular() == null || proveedor.getTelefonoCelular().trim() == "" || proveedor.getTelefonoCelular().isEmpty()) {
			...
			System.out.println("Se procede a validar tel√©fono celular");
			...
			if (!matcher.matches()) {
				...
				FacesContext.getCurrentInstance().addMessage(null,
						new FacesMessage(FacesMessage.SEVERITY_ERROR, "Formato de telÈfono celular inv·lido", ""));
				listarEntidad();
				return "";
		...
		if (proveedor.getTelefonoFijo() == null || proveedor.getTelefonoFijo().trim() == "" || proveedor.getTelefonoFijo().isEmpty()) {
			...
			System.out.println("Se procede a validar tel√©fono fijo");
