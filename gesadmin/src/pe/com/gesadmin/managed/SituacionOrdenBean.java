...
import pe.com.gesadmin.service.impl.SituacionOrdenServiceImpl;


@ManagedBean
@ViewScoped
public class SituacionOrdenBean {

	private List<SituacionOrden> lista = new ArrayList<>();
	private List<SituacionOrden> listafiltro;
	private SituacionOrden entidad = new SituacionOrden();
	private SituacionOrden entidadseleccionada = new SituacionOrden();

	private String filtro;

	@EJB
	private SituacionOrdenService servicio = new SituacionOrdenServiceImpl();

	public SituacionOrdenBean() {
	...
	public List<SituacionOrden> getLista() {
		return lista;
	}

	public void setLista(List<SituacionOrden> lista) {
		this.lista = lista;
	}

	public List<SituacionOrden> getListafiltro() {
		return listafiltro;
	}

	public void setListafiltro(List<SituacionOrden> listafiltro) {
		this.listafiltro = listafiltro;
	}

	public SituacionOrden getEntidad() {
		return entidad;
	}

	public void setEntidad(SituacionOrden entidad) {
		this.entidad = entidad;
	}

	public SituacionOrden getEntidadseleccionada() {
		return entidadseleccionada;
	}

	public void setEntidadseleccionada(SituacionOrden entidadseleccionada) {
		this.entidadseleccionada = entidadseleccionada;
	}

	public void setServicio(SituacionOrdenService servicio) {
	...
	public void onRowSelect(SelectEvent event) {
		if (entidadseleccionada == null) {
			entidad = new SituacionOrden();
			entidadseleccionada = new SituacionOrden();
			FacesContext.getCurrentInstance().addMessage(null,
