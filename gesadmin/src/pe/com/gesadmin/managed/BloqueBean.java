...
@ManagedBean
@ViewScoped
public class BloqueBean {

	private List<Bloque> lista = new ArrayList<>();
	private List<Bloque> listafiltro;
	private Bloque entidad = new Bloque();
	private Bloque entidadseleccionada = new Bloque();

	private String filtro;

	@EJB
	private BloqueService servicio = new BloqueServiceImpl();
	...
	public List<Bloque> getListafiltro() {
		return listafiltro;
	}

	public void setListafiltro(List<Bloque> listafiltro) {
		this.listafiltro = listafiltro;
	}

	public Bloque getEntidad() {
		return entidad;
	}

	public void setEntidad(Bloque entidad) {
		this.entidad = entidad;
	}

	public Bloque getEntidadseleccionada() {
		return entidadseleccionada;
	}

	public void setEntidadseleccionada(Bloque entidadseleccionada) {
		this.entidadseleccionada = entidadseleccionada;
	}

	public void setServicio(BloqueService servicio) {
	...
	public void onRowSelect(SelectEvent event) {
		if (entidadseleccionada == null) {
			entidad = new Bloque();
			entidadseleccionada = new Bloque();
			FacesContext.getCurrentInstance().addMessage(null,
