...
public class CargoBean {
	...
	private List<Cargo> listafiltro;
	private Cargo entidad = new Cargo();
	private Cargo entidadseleccionada = new Cargo();

	private String filtro;

	@EJB
	private CargoService servicio = new CargoServiceImpl();
	...
	public List<Cargo> getListafiltro() {
		return listafiltro;
	}

	public void setListafiltro(List<Cargo> listafiltro) {
		this.listafiltro = listafiltro;
	}

	public Cargo getEntidad() {
		return entidad;
	}

	public void setEntidad(Cargo entidad) {
		this.entidad = entidad;
	}

	public Cargo getEntidadseleccionada() {
		return entidadseleccionada;
	}

	public void setEntidadseleccionada(Cargo entidadseleccionada) {
		this.entidadseleccionada = entidadseleccionada;
	}

	public void setServicio(CargoService servicio) {
