...
import pe.com.gesadmin.service.impl.EgresoServiceImpl;
...
public class EgresoBean {
	...
	private List<Egreso> listafiltro;
	private Egreso entidad = new Egreso();
	private Egreso entidadseleccionada = new Egreso();

	private String filtro;

	@EJB
	private EgresoService servicio = new EgresoServiceImpl();
	...
	public void setLista(List<Egreso> lista) {
		this.lista = lista;
	}

	public List<Egreso> getListafiltro() {
		return listafiltro;
	}

	public void setListafiltro(List<Egreso> listafiltro) {
		this.listafiltro = listafiltro;
	}

	public Egreso getEntidad() {
		return entidad;
	}

	public void setEntidad(Egreso entidad) {
		this.entidad = entidad;
	}

	public Egreso getEntidadseleccionada() {
		return entidadseleccionada;
	}

	public void setEntidadseleccionada(Egreso entidadseleccionada) {
		this.entidadseleccionada = entidadseleccionada;
	}

	public void setServicio(EgresoService servicio) {
	...
	public void onRowSelect(SelectEvent event) {
		if (entidadseleccionada == null) {
			entidad = new Egreso();
			entidadseleccionada = new Egreso();
			FacesContext.getCurrentInstance().addMessage(null,
