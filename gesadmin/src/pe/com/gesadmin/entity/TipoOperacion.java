...
public class TipoOperacion implements Serializable {
	...
	public TipoOperacion(Integer id) {
		this.id = id;
	}

	public TipoOperacion(Integer id, String descripcion) {
		this.id = id;
	...
	public String toString() {
		return "TipoOperacion [id=" + id + ", descripcion=" + descripcion + ", estado=" + estado + ", registro="
				+ registro + "]";
	}	
