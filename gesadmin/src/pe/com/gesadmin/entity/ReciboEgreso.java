...
@NamedQuery(name = "ReciboEgreso.findAll", query = "SELECT t FROM ReciboEgreso t")
public class ReciboEgreso implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ReciboEgreso other = (ReciboEgreso) obj;
		if (id == null) {
			if (other.id != null)
				return false;
