...
public class TipoEstatus implements Serializable {
    ...
    public TipoEstatus(Integer id, String descripcion, int estado) {
        this.id = id;
    ...
    public boolean equals(Object obj) {
        ...
        final TipoEstatus other = (TipoEstatus) obj;
    ...
    public String toString() {
        return "TipoEstatus{" + "id=" + id + ", descripcion=" + descripcion + ", estado=" + estado + ", registro=" + registro + '}';
    }
